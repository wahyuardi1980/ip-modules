    ...
    while true do
        ...
        if isInVehicle then
            if vehicleClass == 18 and GetPedInVehicleSeat(vehicle, -1) == ped then
                if PlayerData.job ~= nil and PlayerData.job.name ~= 'police' and PlayerData.job.name ~= 'ambulance' and PlayerData.job.name ~= 'mechanic' and PlayerData.job.name ~= 'montir' and PlayerData.job.name ~= 'tni' and PlayerData.job.name ~= 'state' then
