...
ConfigFishing.checkForUpdates = true -- Check for updates?
ConfigFishing.oldESX = false         -- Nothing to do with qb / Essentially when set to true it disables the check of if player can carry item

ConfigFishing.sellShop = {
    enabled = true,
    coords = vec3(-1296.47, -1387.15, 4.63 - 0.9), -- X, Y, Z Coords of where fish buyer will spawn
    heading = 109.53,                              -- Heading of fish buyer ped
...
ConfigFishing.timeForBite = {
    -- Set min and max random range of time it takes for fish to be on the line.
    min = 2 * seconds,
    max = 20 * seconds
}
...
ConfigFishing.ilegalZone = vector3 { -3007.71, -1905.18, 1.38 }
