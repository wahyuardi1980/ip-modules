...
AddEventHandler('esx_carthief:pay', function(payment)
	...
	--Add cooldown
	cooldown = ConfigCarSteal.CooldownMinutes * 60000
end)
...
ESX.RegisterServerCallback('esx_carthief:anycops', function(source, cb)
	...
	TriggerClientEvent('chat:addMessage', -1, {
		template =
		'<div style="padding: 0.3vw; margin: 0.3vw; background-color: rgba(200, 50, 50, 0.8); border-radius: 3px; text-shadow: 1px 1px #000000"><i class="fas fa-exclamation"></i> <b>BERITA TERKINI: {0}</b></div>',
		args = { "Terjadi Pencurian Kendaraan " }
	})
end)
