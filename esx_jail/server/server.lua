			...
			if jailTime ~= nil then
				...
				if args[3] ~= nil then
					GetRPName(jailPlayer, function(Firstname, Lastname)
						TriggerClientEvent('chat:addMessage', -1, { args = { "BERITA PENJARA",  Firstname .. " " .. Lastname .. " Sekarang dipenjara Selama " .. jailTime .. " Bulan: " .. args[3] }, template = '<div class="chat-message-rs"><b> {0}:</b> {1}</div>', color = { 255, 255, 255 } })
					end)
				end
			else
...
AddEventHandler("esx-qalle-jail:jailPlayer", function(targetSrc, jailTime, jailReason)
	...
	GetRPName(targetSrc, function(Firstname, Lastname)
		TriggerClientEvent('chat:addMessage', -1, { args = { "BERITA PENJARA",  Firstname .. " " .. Lastname .. " Sekarang dipenjara Selama  ".. jailTime .. " bulan " .. jailReason }, template = '<div class="chat-message-rs"><b> {0}:</b> {1}</div>', color = { 255, 255, 255 } })
	end)
