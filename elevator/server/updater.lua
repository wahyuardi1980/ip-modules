...
if ConfigElevator.checkForUpdates then
    ...
    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/wasabirobby/wasabi_elevators/releases/latest", CheckVersion,
            "GET")
            Wait(3600000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/wasabirobby/wasabi_elevators/releases/latest",
